// src/templates/ThemeManager.jsx
...
const ThemeManager = ({ themeId }) => {
  // ⚠️ الثيم 0 = لا يوجد ثيم (خلفية بيضاء فارغة)
    ...
    switch (themeId) {
      ...
      case 3: return (
        <div className="t3-bold-container">
          ...
          <BoldElegantLeaf className="t3-leaf-tr" color="#1a365d" />
          <BoldElegantLeaf className="t3-leaf-bl" color="#2d3822" />
  ...
  return (
    <div
      className={`theme-master theme-${themeId}`}
