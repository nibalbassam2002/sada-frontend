    ...
    <div className="main-wrapper">
      ...
      <section className="hero-section">
        <div className="hero-text-content">
          ...
          <h1 className="hero-title">Make presentations <br/> <span>unforgettable.</span></h1>
          <p className="hero-desc">The simplest way to engage your audience with live polls, Q&As, and real-time feedback. Designed for modern presenters.</p>
          ...
          <div style={{fontSize: '13px', color: '#94a3b8', fontWeight: 600, marginTop: '10px'}}>Trusted by 10,000+ presenters worldwide</div>
        </div>
      ...
      <section id="how" className="process-section">
        ...
        <div className="process-grid">
          <div className="step-card">
            <div className="feature-icon-box" style={{background: '#fff7ed'}}><Layout size={28} /></div>
          ...
          <div className="step-card">
            <div className="feature-icon-box" style={{background: '#eff6ff', color: '#3b82f6'}}><Users size={28} /></div>
      ...
      <section id="features" className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card large">
             ...
             <p style={{color: 'var(--slate)', fontSize: '15px', marginTop: '10px'}}>Automatically generate poll questions and slide content using our smart AI assistant.</p>
          </div>
          ...
          <div className="feature-card large" style={{background: 'linear-gradient(135deg, #f0f9ff 0%, #ffffff 100%)', borderColor: '#e0f2fe'}}>
             ...
             <p style={{color: 'var(--slate)', fontSize: '15px', marginTop: '10px'}}>Your data is fully encrypted and sessions are private.</p>
          </div>
        </div>
      </section>
      ...
      {/* 6. Footer */}
       <footer className="footer-modern">
        <div className="footer-grid">
          ...
          <div><h4 className="footer-heading">Product</h4><ul className="footer-links-list"><li><a href="#features">Features</a></li><li><a href="#how">How it works</a></li></ul></div>
          <div><h4 className="footer-heading">Support</h4><ul className="footer-links-list"><li><a href="#">Help Center</a></li><li><a href="#">API Docs</a></li></ul></div>
          <div><h4 className="footer-heading">Company</h4><ul className="footer-links-list"><li><a href="#">About Us</a></li><li><a href="#">Privacy Policy</a></li></ul></div>
        </div>
        <div className="footer-bottom">
          <div className="footer-bottom-text">© 2024 SADA Interactive. Designed for better presentations.</div>
          <div style={{display: 'flex', alignItems: 'center', gap: '5px', fontSize: '13px', color: '#94a3b8', fontWeight: 700}}><Mail size={14} /> support@sada.io</div>
        </div>
      </footer>
    </div>
  );
