  ...
  return (
    <div className="main-wrapper">
        ...
        <div className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
          ...
          {token && userData ? (
            <div className="user-menu-container" ref={userMenuRef}>
              ...
              {isUserMenuOpen && (
                <div className="user-dropdown-v2">
                  ...
                  <Link to="/dashboard" className="d-item" onClick={() => setIsMenuOpen(false)}>
            ...
            <div className="guest-auth-group">
              <Link to="/login"    className="btn-login-outline" onClick={() => setIsMenuOpen(false)}>Login</Link>
              <Link to="/register" className="btn-primary"       onClick={() => setIsMenuOpen(false)}>Get Started Free</Link>
            </div>
          )}
        </div>
      </nav>
      ...
      <section className="hero-section">
        <div className="hero-text-content">
          ...
          <div className="join-container">
            <input
              type="text"
              placeholder="Enter session code (e.g. 123456)"
              value={joinCode}
        ...
        <div className="presentation-visual">
          <div className="screen-mockup">
            <div style={{ position: 'absolute', top: '20px', right: '20px', background: '#ef4444', color: 'white', padding: '4px 12px', borderRadius: '100px', fontSize: '10px', fontWeight: 900 }}>
              LIVE
            </div>
            <div className="slide-body">
              ...
              <div className="result-row">
                ...
                <div className="progress-track"><div className="progress-fill" style={{ width: '18%', opacity: 0.3 }} /></div>
              </div>
            </div>
      ...
      <section id="how" className="process-section">
        <h2 style={{ fontSize: '42px', fontWeight: 800, letterSpacing: '-1.5px' }}>
          Experience seamless interaction
        </h2>
        <p style={{ color: 'var(--slate)', fontSize: '18px', marginTop: '10px' }}>
          Connecting presenters and audiences in real-time.
        </p>
        ...
        <div className="process-grid">
          ...
          <div className="step-card">
            ...
            <div className="steps-list">
              <div className="step-item"><div className="step-dot">1</div><span>Visit sada.app on any mobile browser.</span></div>
      ...
      <section id="features" className="features-section">
        <div style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto' }}>
          <span style={{ color: 'var(--primary)', fontWeight: 800, fontSize: '12px', letterSpacing: '2px' }}>
            CORE CAPABILITIES
          </span>
        ...
        <div className="features-grid">
          <div className="feature-card large">
            ...
            <p style={{ color: 'var(--slate)', fontSize: '15px', marginTop: '10px' }}>
              Automatically generate poll questions and slide content using our smart AI assistant.
            </p>
          </div>
          ...
          <div className="feature-card large" style={{ background: 'linear-gradient(135deg, #f0f9ff 0%, #ffffff 100%)', borderColor: '#e0f2fe' }}>
            ...
            <p style={{ color: 'var(--slate)', fontSize: '15px', marginTop: '10px' }}>
              Your data is fully encrypted and sessions are private.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="premium-cta">
          ...
          <div style={{ position: 'relative', display: 'flex', gap: '15px', justifyContent: 'center' }}>
            <Link
              ...
              className="btn-primary"
              style={{ padding: '16px 40px', fontSize: '15px', textDecoration: 'none' }}
            >
      ...
      <footer className="footer-modern">
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-text">© 2025 SADA Interactive. Designed for better presentations.</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '5px', fontSize: '13px', color: '#94a3b8', fontWeight: 700 }}>
            <Mail size={14} /> support@sada.app
          </div>
        </div>
      </footer>
