...
const SlideCanvas = () => {
  ...
  // حساب الحجم المناسب بناءً على حجم الـ workspace
  useEffect(() => {
    const updateScale = () => {
      ...
      const scale = Math.min(scaleX, scaleY, 1); // لا تكبر أكثر من 100%
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          flexShrink: 0,
          // الظل والحدود بدون أي overflow
          boxShadow: '0 8px 40px rgba(0,0,0,0.18), 0 2px 8px rgba(0,0,0,0.10)',
          borderRadius: '2px',
          background: '#fff',
          // transform فقط للـ scale دون أي تأثير على الـ z-index أو الـ stacking context
          ...(scaledSize.scale && scaledSize.scale !== 1 ? {
            transformOrigin: 'center center',
          } : {})
        }}
      >
        {/* الشريحة الفعلية بحجم ثابت 960×540 مع scale */}
        <div
          ...
          style={{
            ...
            // لا overflow: hidden هنا - نتركه للـ outer wrapper
            overflow: 'visible',
          }}
        >
          {/* Gridlines */}
          ...
          {showGuides && (
            <div
              ...
              style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 101 }}
            >
          ...
          {/* Theme Background - طبقة الخلفية فقط */}
          <div style={{
            position: 'absolute',
            inset: 0,
            zIndex: 1,
        ...
        {/* Clip overflow للـ outer wrapper بعد الـ inner */}
        <div style={{
          position: 'absolute',
          inset: 0,
          overflow: 'hidden',
      ...
      {/* Notes Panel - خارج الـ slide تماماً */}
      {showNotes && (
        <div style={{
          width: `${scaledSize.width || 960}px`,
          maxWidth: '960px',
        ...
        <div className="footer-controls" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div className="zoom-display" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            <button
              ...
              style={{ width: '20px', height: '20px', border: '1px solid #ddd', background: '#fff', cursor: 'pointer', borderRadius: '3px', lineHeight: 1 }}
            >−</button>
          ...
          <button
            ...
            style={{ background: 'none', border: '1px solid #ddd', cursor: 'pointer', fontSize: '12px', color: '#666', borderRadius: '3px', padding: '1px 6px' }}
          >
            Fit
          </button>
        </div>
